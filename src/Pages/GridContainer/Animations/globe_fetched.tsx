...
const World = dynamic(() => import("../Components/ui/globe_collector").then((m) => m.World), {
  ...
  return (
    <div className="flex md:h-auto dark:bg-black bg-white relative w-full">
    <div className="max-w-9xl mx-auto w-full relative overflow-hidden h-[20rem] px-4">
      <div className="absolute w-full bottom-0 inset-x-0 h-40 bg-gradient-to-b pointer-events-none select-none from-transparent dark:to-black to-white z-40" />
      <div className="w-full h-96 md:h-[40rem] z-10 relative">
        {/* World Component as Background */}
