...
import { DirectionDeterminingConstants, INFINITE_MOVING_CARDS_ATTRIBUTES, SpeedDeterminingConstants } from "@/Pages/InfiniteScrollers/Constants";
interface InfiniteMovingCardsProps {
  items:{ href: string; }[]; 
  className?: string;
  pauseOnHover?: boolean;
  direction?: DirectionDeterminingConstants | string
  speed?: SpeedDeterminingConstants | string
}
 const infinite_cards_props : InfiniteMovingCardsProps = {
  items : clients,
  className :"w-full",
  pauseOnHover : true,
  direction : INFINITE_MOVING_CARDS_ATTRIBUTES.direction_defined_forth,
  speed : INFINITE_MOVING_CARDS_ATTRIBUTES.speed_determining_constant_low
}
